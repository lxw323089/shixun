...
import com.example.workermanagement.mapper.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initDepartments() {
        ...
        for (Department d : Arrays.asList(d1, d2, d3, d4, d5)) {
    ...
    private void initWorkers() {
        ...
        for (Worker w : Arrays.asList(w1, w2, w3, w4, w5, w6, w7, w8, w9, w10)) {
    ...
    private void initAttendances() {
        ...
        for (Attendance a : Arrays.asList(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)) {
    ...
    private void initSalaries() {
        ...
        for (Salary s : Arrays.asList(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10)) {
    ...
    private void initUsers() {
        ...
        for (User u : Arrays.asList(u1, u2, u3, u4, u5, u6)) {
            userMapper.insert(u);
        }
    }
    ...
    private void initOperationLogs() {
        ...
        List<OperationLog> logs = Arrays.asList(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10);
